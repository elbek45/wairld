<template>
  <div>
    <div class="table-head">
      <h1 class="pageTitle20">Articles</h1>
      <nuxt-link class="btn btn-primary" to="/admin/articles/create">Add new</nuxt-link>
    </div>
    <table class="table-1">
      <thead>
        <tr>
      ...
      <tbody v-if="models.length">
        <tr v-for="(model,index) in models" :key="index">
          ...
          <td>
            <nuxt-link class="btn btn-sm btn-primary" :to="`/admin/articles/update/${model.id}`">Edit</nuxt-link>
